...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:param name="schema-krajow" select="'/static/css/KodyKrajow_v6-0E.xsd'"/>
	<xsl:param name="schema-urzedow" select="'/static/css/KodyUrzedowSkarbowych_v6-0E.xsd'"/>
	<xsl:param name="schema-naczelnikow-urzedow" select="'/static/css/KodyNaczelnikowUrzedowSkarbowych_v4-0E.xsd'"/>
	<xsl:template match="/">
		<html>
			<head>
				<title>
	...
	<xsl:template name="MiejsceICel">
		...
		<table class="normalna">
			<tr>
				<td class="niewypelnianeopisy" style="width:30%">Kod i nazwa urzędu skarbowego, do którego adresowany jest dokument</td>
