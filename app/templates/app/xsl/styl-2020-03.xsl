<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:pf="http://crd.gov.pl/wzor/2020/03/06/9196/" version="1.0" xmlns:exsl="http://exslt.org/common" extension-element-prefixes="exsl">
	<xsl:import href="/static/css/Posredni_wspolne_v7-0E.xsl"/>
	...
	<xsl:template name="Sprzedaz">
		...
		<xsl:for-each select="pf:SprzedazWiersz">
			<table>
				<tr>
					<td class="tytul-sekcja-blok" style="text-transform: none; font-weight: bold; font-size: 1.0em; ">
							Lp. wiersza ewidencji - <span style="font-size: 1.3em;">
	...
	<xsl:template name="EwidencjaPodatkuNaliczonego">
		...
		<table>
			<tr>
				<td class="tytul-sekcja-blok" style="text-transform: none; font-weight: bold; font-size: 1.1em; ">
							Lp. wiersza ewidencji - <span style="font-size: 1.2em;">
