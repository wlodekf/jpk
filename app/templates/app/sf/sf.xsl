...
<xsl:param name="schema-nazwy" select="'/static/css/JednostkaInnaStrukturyDanychSprFin_v1-0.xsd'"/>
<xsl:param name="schema-podatek" select="'/static/css/StrukturyDanychSprFin_v1-1.xsd'"/>
